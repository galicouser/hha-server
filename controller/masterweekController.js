...
const getmasterweeksById = async (req, res) => {
    ...
    req.mysql.query(`SELECT * FROM masterweek WHERE id = ${id}`, (error, results, fields) => {
      if (error) {
  ...
  const deleteMasterWeekById = async (req, res) => {
    ...
    req.mysql.query(`DELETE FROM masterweek WHERE id = ${id}`, (error, results, fields) => {
        if (error) {
